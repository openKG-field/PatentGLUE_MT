...
class Trainer(object):
    ...
    def _save_model(self, epoch, ckpt_save_path, is_best_epoch):
        ...
        torch.save(checkpoint, '{}/checkpoint_{}.pt'.format(ckpt_save_path, epoch), _use_new_zipfile_serialization=True)
        ...
        if is_best_epoch:           
            torch.save(checkpoint, '{}/checkpoint_best.pt'.format(ckpt_save_path), _use_new_zipfile_serialization=True)
